...
namespace RolePlayHelper.DAL.Migrations
{
    ...
    [Migration("20251218123211_SeederFix")]
            ...
            modelBuilder.Entity("RolePlayHelper.DL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$4Bk7DtlD2JzaZGpOUw5ROQ$JbPOaxetkNOxYHSRuKqS2F+9vJn5/J6jn8BoRApsXC0",
                            Role = "Admin",
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$9glTmguTWBB6wHHNf9D3SA$QCS23zNLmYljZvBawwE+N67Id9o0BeepoCfN0X8FHs4",
                            Role = "User",
                            UserName = "default"
                        });
                });
            ...
            modelBuilder.Entity("RolePlayHelper.DL.Entities.Character", b =>
                {
                    ...
                    b.HasOne("RolePlayHelper.DL.Entities.User", "User")
                        .WithMany("Characters")
